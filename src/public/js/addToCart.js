...
function updateCart(backPack) {
  axios.post('/update-cart', backPack).then(function (res) {
    //console.log(res)
...
addToCart.addEventListener('click', function () {
  var backPack_OBJ = JSON.parse(addToCart.dataset.backpack); //console.log(backPack_OBJ);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbinglasses"] = self["webpackChunkbinglasses"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["src/public/css/style"], () => (__webpack_require__("./src/resources/js/addToCart.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["src/public/css/style"], () => (__webpack_require__("./src/resources/sass/app.scss")))
