...
(() => {
/*!*******************************************!*\
  !*** ./src/resources/js/removeProduct.js ***!
  \*******************************************/
var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

var Noty = __webpack_require__(/*! noty */ "./node_modules/noty/lib/noty.js");

var btnRemove = document.querySelectorAll('.btn-remove-product');
var qty = document.querySelectorAll('.qty');
var countProduct = document.querySelector('.count');
var totalPrice = document.getElementById('totalPrice');
var productInCart = document.querySelectorAll('.item-in-cart');

function reduceQty(dataProduct, qty, productInCart) {
  axios.post('reduce-qty', dataProduct).then(function (res) {
    //console.log(res);
...
var _loop = function _loop(i) {
  btnRemove[i].addEventListener('click', function () {
    var dataProduct_OBJ = JSON.parse(btnRemove[i].dataset.product);
